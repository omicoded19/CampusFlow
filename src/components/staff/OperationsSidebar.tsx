...
function OperationsSidebar({ user, mode, isLoggingOut, onLogout }: OperationsSidebarProps) {
  ...
  return (
    <aside className="sticky top-0 hidden h-screen w-[235px] shrink-0 self-start flex-col overflow-y-auto border-r border-slate-200 bg-white px-4 py-5 lg:flex">
